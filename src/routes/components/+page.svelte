<div class="p-4 flex flex-col gap-4">
  ...
  <p class="text-sm leading-6 font-semibold text-primary">Components overview</p>
  <h1 class="text-3xl sm:text-4xl font-extrabold text-on-surface">Components in Tailwind Material</h1>
  <p class="leading-6 font-semibold text-on-surface-variant">
    ...
    <a class="flex flex-row gap-6 flex-auto max-w-fit min-h-[418px]" href="/components/common-buttons">
      <article class="h-auto bg-surface-container rounded-3xl max-w-sm cursor-pointer">
        <figure class="bg-suface h-1/2 rounded-3xl flex items-center justify-center bg-surface-container-high">
          <button class="md-button-filled">COMMON BUTTON</button>
        </figure>
        <div class="flex flex-col p-4 gap-2">
          <h2 class="text-2xl font-semibold">Common Buttons</h2>
          <p class="text-lg ">
            Buttons prompt most actions in a user interface.
          </p>
        </div>
      </article>
    </a>
