<div class="lg:h-dvh p-4 overflow-y-auto flex-auto flex flex-col">
  ...
  <h1 class="text-4xl font-bold text-center p-4">News & Updates</h1>
  <main class="flex gap-4 justify-center">
      <a class="flex max-w-fit flex-row gap-6 flex-auto min-h-[418px]" href="/components">
        <article class="h-auto bg-surface-container rounded-3xl max-w-sm cursor-pointer">
          <figure class="bg-primary h-1/2 rounded-3xl flex items-center justify-center">
            <h2 class="text-on-primary text-pretty text-8xl font-bold md-icon-button icon-filled">add_circle</h2>
          </figure>
          <div class="flex flex-col p-4 gap-2">
            <h2 class="text-2xl font-semibold">Components</h2>
            <p class="text-lg ">
              Basic html elements styled with minimal css possible.
            </p>
          </div>
        </article>
      </a>
      <a class="flex max-w-fit flex-row gap-6 flex-auto min-h-[418px]" href="/foundations">
        <article class="h-auto bg-surface-container rounded-3xl max-w-sm cursor-pointer">
          ...
          <div class="flex flex-col p-4 gap-2">
            <h2 class="text-2xl font-semibold">Basic color roles injection</h2>
            <p class="text-lg ">
              All material design tokens are inject in the html body with tailwind
              intellicense support.
            </p>
          </div>
        </article>
      </a>
